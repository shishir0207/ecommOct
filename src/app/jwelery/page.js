...
const Jwelery = ({item}) => {
  ...
  return (
   <>
   <div className='bg-[#FFFCF2] h-screen' >
   <div className='text-5xl text-center'>Jewellery</div>
    ...
    <h4 className='text-xs text-yellow-500'>{item?.rating?.rate} ratings</h4>
    
    <p className='text-xs line-clamp-2 mt-1'>{item?.description}</p>

    <h3 className='text-md font-semibold mt-1'>Price- ${item?.price}</h3>
